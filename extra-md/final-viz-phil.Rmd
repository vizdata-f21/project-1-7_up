...
income_mean %>%
  ...
  geom_text(
    ...
    aes(y = race, 
        label = paste0(round(percent, 2)*100, "%")),
        x = 0.15, size = 2.75,
        color = "black") +
  scale_fill_brewer(type = "seq", palette = "Blues", direction = -1) +
  labs(
    title = "Income Gap: How much do top households earn vs. bottom households per race?",
    subtitle = "Source: U.S. Census 2019 Data",
    x = "Proportion of income (%) earned for each household quintile", 
    y = "Race", 
