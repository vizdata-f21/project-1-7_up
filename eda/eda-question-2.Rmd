...
```{r plot3}
# the following dataframe that I created shows the total values for each box 
# based on race and income quintile. 
# finding a way to merge both dataframes should allow it so that the geom_text 
# label
# can access the data.
# link for help: 
