...
total <- cbind(income_mean_use, income_mean_sum)

ggplot(total, aes(fill = income_percentile, 
  ...
  coord_flip() 
  #geom_text(data = income_mean_sum, aes(label = round(total_value,1)),size = 3, position = position_stack(vjust = 0.5))
