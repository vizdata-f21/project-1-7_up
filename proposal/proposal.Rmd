...
**Question 1: ** How do wealth and income distribution across different racial groups has changed over time?

In general, we hypothesize that the gap between different racial groups gradually decreases over time.

ACROSS DIFFERENT RACES (time series)


**Question 2: ** The second question we would like to explore is to see how 
homeownership and student debt loans has changed over time among different racial groups. 
